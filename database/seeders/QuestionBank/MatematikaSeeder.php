...
class MatematikaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            [
                "Jika $4^m = 25$, maka $2^{m+3} + 4^m = \dots$",
                "1"
            ],
            [
                "Nilai dari $\sqrt{4 + \sqrt{7}} - \sqrt{4 - \sqrt{7}} = \dots$",
                "1"
            ],
            [
                'Jika $A + A^3 = 5$, maka nilai $B$ adalah $\dots$',
                "1"
            ],
            [
                'Proyeksi titik $(3,4)$ pada garis $y=x$ adalah $\dots$',
                "2"
            ],
            [
                'Parabola $y=x^2-3x+6$ digeser ke kanan sejauh 3 satuan searah dengan sumbu $-x$ dan digeser ke bawah sejauh 4 satuan. Jika parabol hasil pergeseran ini memotong sumbu $-x$ di $x_1$ dan $x_2$ maka $x_1+x_2 = \dots$',
                "2"
            ],
            [
                'Diketahui suatu deret aritmetika dengan rumus jumlah n suku pertama $S_n=n^2+4n$. Persamaan kuadrat yang dibentuk dari suku ke-7 dan beda deretnya sebagai akar-akar adalah $\dots$',
                "2"
            ],
            [
                'Dalam daerah yang dibatasi oleh sistem pertidaksamaan $x+y \leq 30$, $3y \leq x+30$, $x \geq 0$ dan $y \geq 0$, maka nilai maksimun dari $2x+3y$ adalah $\dots$',
                "3"
            ],
            [
                'Sebuah pabrik memproduksi dua jenis barang, yaitu barang A dan barang B. Untuk membuat 1 unit barang A, diperlukan waktu 4 jam pada mesin I dan 2 jam pada mesin II. Untuk membuat 1 unit barang B, diperlukan waktu 3 jam pada mesin I dan 5 jam pada mesin II. Kedua mesin memiliki batasan waktu kerja harian yaitu tidak beroperasi lebih dari 20 jam per hari. Jika pabrik menghasilkan x unit barang A dan y unit barang B setiap hari, maka model matematika yang merepresentasikan batasan-batasan ini adalah $\dots$',
                "3"
            ],
            [
            ...
            [
                'Dalam sebuah segitiga ABC, panjang sisi BC adalah 125 cm. Diketahui besar sudut ABC adalah $45^\circ$ dan sudut BCA adalah $60^\circ$. Panjang sisi AC = $\dots$',
                "4"
            ],
            [
                'Sebuah kapal berlayar dari titik awal ke arah timur sejauh 20 mil. Perjalanan kedua dilanjutkan dengan arah $30^\circ$ sejauh 50 mil. Berapakah jarak garis lurus dari posisi akhir kapal ke titik keberangkatan?',
                "4"
            ],
            [
                'Diketahui $\sin\alpha=\frac{1}{3} \cdot \frac{1}{2}$, $\alpha$ adalah sudut lancip, maka nilai $\cos 2\alpha$ adalah $\dots$',
                "4"
            ],
            [
                'Jika matriks $M = \begin{pmatrix} 2 & 1 \\\\ -1 & 2 \end{pmatrix}$ dan $N = \begin{pmatrix} -1 & 0 \\\\ 0 & 1 \end{pmatrix}$ maka matriks $2NM - MN = \dots$',
                "5"
            ],
            [
                'Diketahui matriks $A=\begin{pmatrix} 1 & 2 \\ 3 & 4 \end{pmatrix}$ dan $B=\begin{pmatrix} 1 & 2 \\ 2 & 1 \end{pmatrix}$. Matriks $A-kB$ adalah matriks tunggal, maka untuk nilai $k=\dots$',
                "5"
            ],
            [
                'Jika matriks $A$ memenuhi $A\begin{pmatrix} 3 & 2 \\ 5 & 4 \end{pmatrix} = \begin{pmatrix} 7 & 6 \\ 9 & 8 \end{pmatrix}$, maka $\det A = \dots$',
                 "5"
            ],
            [
                'Turunan pertama dari fungsi $f(x)=5x^3-1$ adalah $f\'(x)= \dots$',
                "6"
            ],
            [
                'Dua bilangan bulat $m$ dan $n$ memenuhi hubungan $4m+2n=40$. Nilai minimun dari $p=m^2+n^2$ adalah $\dots$',
                "6"
            ],
            [
                'Suatu proyek dikerjakan selama $x$ hari dengan biaya setiap harinya $\left(2x+\frac{1000}{x}-24\right)$ juta rupiah. Jika biaya minimun proyek adalah Y juta rupiah, maka Y = $\dots$',
                "6"
            ],
            [
                'Nilai tes matematika 25 orang siswa memiliki ciri-ciri sebagai berikut: selisih nilai terbesar dan terkecil adalah 4,5 dan rata-rata nilai 23 siswa lainnya adalah 7,4. Jika rata-rata nilai seluruh siswa adalah 7,6, maka nilai terkecilnya adalah $\dots$',
                "7"
            ],
            [
                'Data berikut adalah tinggi badan sekelompok siswa. Median data di atas adalah $167,8$ cm, maka nilai $X$ adalah $\dots$',
                "7"
            ],
            [
                'Suatu data mempunyai rata-rata 25 dan jangkauan 5. Jika setiap nilai dalam data dikalikan $x$ kemudian dikurangi $y$, didapat data baru dengan rata-rata 35 dan jangkauan 7. Nilai $5x-y$ adalah $\dots$',
                "7"
            ],
            [
                'Seseorang melakukan perjalanan pulang-pergi dari kota A ke kota C, dengan transit di kota B. Terdapat 5 bus yang melayani rute dari kota A ke B, dan 4 bus untuk rute dari B ke C. Pada perjalanan pulang dari C ke A, orang tersebut tidak ingin menggunakan bus yang sama seperti saat berangkat, maka banyak cara yang berbeda untuk melakukan perjalanan ini adalah $\dots$',
                "8"
            ],
            [
