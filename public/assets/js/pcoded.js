// 'use strict';
var flg = '0';
const logo_light = window.baseUrl + 'logo/' + window.Laravel.logoWhite;
const logo_dark = window.baseUrl + 'logo/' + window.Laravel.logoDark;
// const logo_light = '../images/logo-optik-0.png';
// const logo_dark = '../images/logo-optik-0.png';
    ...
    if (layout !== null && layout !== '') {
        ...
        if (layout === 'horizontal') {
            ...
            if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
                document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', logo_light);
            }
...
for (var t = 0; t < tc.length; t++) {
    tc[t].setAttribute('src', logo_light);
}
...
function layout_change(layout) {
    ...
    if (layout == 'dark') {
        ...
        if (document.querySelector('.navbar-brand .logo-lg')) {
            document.querySelector('.navbar-brand .logo-lg').setAttribute('src', logo_light);
        }
        if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
            document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', logo_light);
        }
        if (document.querySelector('.footer-top .footer-logo')) {
            document.querySelector('.footer-top .footer-logo').setAttribute('src', logo_light);
        }
