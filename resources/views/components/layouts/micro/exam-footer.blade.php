                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <ul class="list-unstyled footer-link">
                                ...
                                <li>
                                    <a href="https://phoenixcoded.gitbook.io/able-pro/roadmap/" target="_blank">Feature Request</a>
                                </li>
                                <li>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col my-1 wow fadeInUp" data-wow-delay="0.4s">
                <p class="mb-0">
                    © Handcrafted by Team
                    <a href="https://themeforest.net/user/phoenixcoded" target="_blank">IT</a>
                </p>
            </div>
